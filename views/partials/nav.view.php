                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/" class="<?= urlIs('/') ? STYLES_CONFIG['nav-active'] : STYLES_CONFIG['nav-inactive'] ?> px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Dashboard</a>
                                ...
                                <a href="/users" class="<?= urlIs('/users') ? STYLES_CONFIG['nav-active'] : STYLES_CONFIG['nav-inactive'] ?> px-3 py-2 rounded-md text-sm font-medium">Users</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
